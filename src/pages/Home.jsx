...
export const Home = ({md,setmd}) => {
  ...
  scopeRaf.current.addEventListener("mouseleave",()=>{
    gsap.to('.cursor',{
      height:0,
      width:0,
      opacity:0,
  ...
  return (
    ...
    <Header current={1}md={md} setmd={setmd}/>
              ...
              <div style={{height : 88 + "vh"}} className="dev container-fluid flex-column d-flex justify-content-center gap-2 align-items-center page1"  >
              
              <div className="row  justify-content-center">

                <span ref={home_titleRef} style={{lineHeight:30+"px"}} className={`fs-1  col-8  text-${md.color} line-height-1 home-title`}> <span className="fs-5 mb-0">hello my self nitin solanki </span> <br/>web develloper</span>
    ...
    <div className="tap tap1">Lorem ipsum dolor sit amet consectetur adipisicing elit. Accusantium necessitatibus sunt tempora! Voluptatum deserunt dolore, velit ducimus optio magni similique corrupti laborum non sit eveniet incidunt explicabo cumque ullam officiis.</div>
    </div>
    
    {/* projects section start */}
    <section className="page page1 container my-5 " >
    ...
    <section ref={scopeRaf} className={` border-top border-${md.color} border-bottom mb-2 py-2 py-md-4  `}>
